...
<header id="navbar" role="banner" class="<?php print $navbar_classes; ?>">
  <div class="<?php print $container_class; ?>">
    <div class="navbar-header">
      <?php if ($logo): ?>
        <a class="logo navbar-btn navbar-left col-sm-3" href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>">
...
<!-- Added a jumbotron to potentially increase the page width to full screen -->
